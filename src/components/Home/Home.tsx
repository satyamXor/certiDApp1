  ...
  render() {
    return (
     ...
     <div className="homebg">
          ...
          <div className="card ">
            <div className="card-body bluelight-bg">
              ...
              <div className="row">
                <div className="col-sm-12 col-md-12 col-lg-6 description align-items-center justify-content-center Padd_edit">
                  <p className="description wow animated fadeIn delay-2s p_edit animated">
                  CertiÐApp solves the authenticity-related  problems using Kerckhoff's Principle of 
                   Cryptography. Here, instead of traditionally  having complicated and secret certificate
                     printing process, we use a publicly known 
                   secure Elliptic Curve Digital Signature  Algorithm (ECDSA) which is used in SSL.
                  </p>
                </div>
                <div className="col-sm-12 col-md-12 col-lg-6 Padd_edit wow animated fadeInUp delay-2s animated">
          ...
          <div className="card">
            <div className="card body">
              ...
              <div className="row">
                <div className="col-sm-12 col-md-12 col-lg-6 description align-items-center justify-content-center Padd_edit">
                  <p className="description wow animated fadeIn delay-2s p_edit animated">
                  CertiÐApp uses an advanced technique called  RLP to record certificate data on Blockchain. 
                   This let’s certificate issuers include any kind of  data in the certificate
                  </p>
                </div>
                <div className="col-sm-12 col-md-12 col-lg-6 Padd_edit wow animated fadeInUp delay-2s animated">
        ...
        <div>
            <div className="navbar-transparent px-md-0 img pb-md-5 navbar-wrap bg-transparent-overlay " style={{  
                ...
                <div className="container">
                  <div className="row justify-content-center">
                      ...
                      <h4 className="card-title mt80 mb40">CertiÐApp certificates support Multiple Signatures, which means that multiple certifying authorities can sign on one certificate.</h4>
                      </div>
                  </div>
                </div>
            </div>
        ...
        <div className="col-sm-12 col-md-12 col-lg-12  text-center">
            ...
            <p className="mt20 pdb20">
            Copyright 2020 Era Swap
            </p>
        </div>
