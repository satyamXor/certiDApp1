...
function Create(){
  ...
  return (
  <div>
  <Form style={{textAlign:'left'}} onSubmit={(e)=>{e.preventDefault(); return (setShow(true))}}>
  <Form.Group controlId="formGridAddress1">
    <Form.Label>Full Name*</Form.Label>
    <Form.Control required placeholder="Enter Full Name" name = 'name' value = {data.name} onChange={handleChange}  />
  </Form.Group>
 
  <Form.Group controlId="formGridAddress2">
    <Form.Label>Subject*</Form.Label>
    <Form.Control required placeholder="Enter Subject" name = 'subject' value = {data.subject} onChange={handleChange}/>
  </Form.Group>

  <Form.Row>
    <Form.Group as={Col} controlId="formGridCity">
      <Form.Label>Category*</Form.Label>
      <Form.Control required placeholder="e.g. : Participation / Merit / Appreciation "
      name = 'category' value = {data.category} onChange={handleChange}/>
    </Form.Group>
    <Form.Group as={Col} controlId="formGridCity">
      <Form.Label>Score</Form.Label>
      <Form.Control placeholder='e.g : 89.50%' name = 'score' value = {data.score} onChange={handleChange} />
    </Form.Group>
    <Form.Group as={Col} controlId="formGridCity">
    ...
    <Form.Text className="text-muted">You can design your own certificates using simple HTML.</Form.Text> 
    <Form.Control as="textarea" rows={3} name = 'other' value = {data.other} onChange={handleChange}/>
  </Form.Group>
...
<button onClick={SignCertificate}  className="btn btn-primary btn-xl js-scroll-trigger combtn combtn1 mt20 mb30">Sign Certificate</button>
          ...
          <div className="rows text-center mt80 mb30">
            ...
            <div className="col-12 col-sm-10 col-md-8 col-lg-7 col-xl-9 mx-auto mt40 mb40">
              <div className="card card-round ">
                ...
                <div className="">
                     <button onClick={()=> this.setState(prev => ({...prev,create : true}))}  className="btn btn-primary btn-xl js-scroll-trigger combtn combtn1 mt20 mb30 ml10">
                     New  Certificate
                       </button >
